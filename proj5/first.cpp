...
const char *			CL_FILE_NAME = { "compute.cl" };
const float				TOL = 0.0001f;

void				Wait( cl_command_queue );
int					LookAtTheBits( float );
int					trial(int, int, int);


int main(int argc, char *argv[]) {
	/*int NUM_ELEMENTS[9] = {1024, 1024*4, 1024*16, 1024*64, 1024*256, 1024*1024, 1024*1024*4, 1024*1024*16, 1024*1024*64};*/
	/*int LOCAL_SIZE[7] =  {8, 16, 32, 64, 128, 256, 512};*/
	int NUM_ELEMENTS[9] = { 1024, 1024 * 4, 1024 * 16, 1024 * 64, 1024 * 256, 1024 * 1024, 1024 * 1024 * 4, 1024 * 1024 * 16 };
	int LOCAL_SIZE[7] = { 32, 64, 128, 256 };

	printf("GLOBAL_SIZE\tLOCAL_SIZE\tNUM_WORK_GROUPS\tGigaMultsPerSecond\n");

	for (int i = 5; i < 8; i++) {
		for (int j = 0; j < 4; j++) {
			trial(NUM_ELEMENTS[i], LOCAL_SIZE[j], NUM_ELEMENTS[i] / LOCAL_SIZE[j]);
		}
	}
}

int
trial(int NUM_ELEMENTS, int LOCAL_SIZE, int NUM_WORK_GROUPS)
{
