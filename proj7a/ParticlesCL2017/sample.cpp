...
const char *WINDOWTITLE = { "CS475 OpenCL/OpenGL Particle System -- Jiawei Mo" };
...
const int NUM_PARTICLES = 1024*1;		// 1k - 1k * 2^12
const int LOCAL_SIZE    = 512;			// 8 - 512
